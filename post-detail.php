...
<META NAME="description" CONTENT="<?=$titler[1];?> <?=$rpost[3];?>">
...
<? } ?>
            ...
            <tr>
              <td align="center"><table width="728" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="left" style="font-size:12px; color:#666666;"><a href="http://<?=$titler[13];?>" title="หน้าแรก" style="color:#666666;">หน้าแรก</a> » <a href="http://<?=$titler[13];?>/cate-<?=$rct[0];?>/<?=$url;?>" title="<?=$rct[1];?>" style="color:#666666;"><?=$rct[1];?></a> » <?=$rpost[2];?></td>
                </tr>
                <tr>
...
if($rpost[17]!=""){ $tag1=rewrite($rpost[17]); echo "<a href='http://$titler[13]/search-tag.php?tag=$tag7' style='color:#000000'>$rpost[17]</a>, ";} 
?>
                        </font></td>
                      </tr>
                      <tr>
                        <td align="right" style="font-family:'Times New Roman', Times, serif; font-size:12px;">
                          ...
                          <? }else{ ?>
                          <a href="http://<?=$titler[13];?>/confirm-del-post.php?topic_id=<?=$topic_id;?>" onclick="javascript:if(!confirm('ต้องการแจ้งลบข่าวสาร')){return false;}" title="แจ้งลบ">แจ้งลบ</a>
                          <? } ?>
                        </td>
                      </tr>
                    </table></td>
                ...
                <tr>
                  <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td height="30" style="background-image:url(http://<?=$titler[13];?>/img/bg-tab-login.png); background-repeat:repeat-x;">
...
?>
                                        ...
                                        <tr>
                                          <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                              ...
                                              <table width="347" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                  <td width="100" align="center" valign="top"><a href="http://<?=$titler[13];?>/topic-<?=$objResult[0];?>/<?=$url;?>.html" title="<?=$objResult[1];?>">
                                                    <? if($objResult[2]==""){ ?>
                                                  ...
                                                  <td width="242" align="center" valign="top"><table width="242" border="0" align="center" cellpadding="0" cellspacing="0">
                                                      <tr>
                                                        <td align="left"><a href="http://<?=$titler[13];?>/topic-<?=$objResult[0];?>/<?=$url;?>.html" title="<?=$objResult[1];?>" style="font-family:'Times New Roman', Times, serif; font-size:12px; font-weight:bold; color:#03379b;"><?=$objResult[1];?></a></td>
                                                      </tr>
                                                      <tr>
                                                        <td align="left"><font size="2" color="#999999"> <? echo mb_substr("$objResult[3]", 0,120,"UTF-8"); ?> </font></td>
                                                      </tr>
                                                      <tr>
  ...
  fjs.parentNode.insertBefore(js, fjs);
                            ...
                            <div class="fb-comments" data-href="http://<?=$titler[13];?>/topic-<?=$topic_id;?>/<?=$topic;?>.html" data-num-posts="10" data-width="720"></div></td>
                      </tr>
                    </table>
                    <? 
			}else if($rpost[6]==2){ 
