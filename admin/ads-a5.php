                          ...
                          <td align="center" valign="top"><?php if($objResult1[1]==1){?>
                              <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                  ...
                                  <a href="edit-ads-a5.php?id=<?php echo $objResult1[0]; ?>" class='btn btn-warning btn-xs white'>
                                      <i class="glyphicon glyphicon-pencil"></i> แก้ไข
                                    </a>
                                    <a href="del-ads5.php?id=<?php echo $objResult1[0]; ?>" onclick="javascript:if(!confirm('ท่านต้องการลบข้อมูลจริงหรือไม่')){return false;}" class='btn btn-danger btn-xs white'>
                            ...
                            <form class="form-horizontal" role="form">
                                ...
                                <div class="form-group">
                                  <div class="col-sm-8">
                                    ...
                                    <a href="del-ads5.php?id=<?php echo $objResult1[0]; ?>&amp;op=<?php echo $objResult1[9]; ?>" onclick="javascript:if(!confirm('ท่านต้องการลบข้อมูลจริงหรือไม่')){return false;}" class='btn btn-danger btn-xs white'>
                                      <i class="glyphicon glyphicon-remove"></i> ลบ
                                    </a>
                                  </div>
                                </div>
