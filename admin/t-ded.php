        ...
        <td bgcolor="#CCCCCC"><table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="760" align="center" valign="top" bgcolor="#FFFFFF"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="25"><strong><font size="2"><img src="../img/icon_bullet_arrow_small.gif" width="9" height="9" /> จัดการข้อมูลทีเด็ด<?=$r[1];?></font></strong></td>
                  </tr>
                  <tr>
                    <td><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="30"><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                              <td width="300" align="left"><font size="2" color="#333333"><strong>:: รายการข้อมูลทีเด็ด<?=$r[1];?>
:: </strong></font></td>
                              <td width="300" align="right"><font size="2" color="#333333"><strong>[ <a href="add-t-ded.php?l_id=<?=$l_id;?>">เพิ่มข้อมูลข้อมูลทีเด็ด<?=$r[1];?>
                              </a> ]
</strong></font></td>
                            </tr>
                          </table></td>
...
?>
                            <tr>
                              <td width="500" height="25" align="left" valign="middle"><font size="2">&nbsp;&nbsp;<a href="league-t-ded.php?l_id=<?=$l_id;?>&amp;tdate=<?=$objResult[0];?>">ทีเด็ดฟุตบอล วิเคราะห์บอล ราคาบอล ประจำวันที่ 
                                <? $postDate=$objResult[0]; echo DateThai($postDate); ?></a>
                              </font></td>
                              <td width="100" height="25" align="center" valign="middle"><font size="2"><a href="league-t-ded.php?l_id=<?=$l_id;?>&amp;tdate=<?=$objResult[0];?>"><img src="images/edit.gif" width="40" height="15" border="0" /></a> <a href="del-t-ded.php?l_id=<?=$l_id;?>&tdate=<?=$objResult[0];?>" onclick="javascript:if(!confirm('ท่านต้องการลบข้อมูลจริงหรือไม่')){return false;}"> <img src="images/del.gif" width="40" height="15" border="0" /></a></font></td>
                            </tr>
                            <? } ?>
                        </table></td>
                      </tr>
                      <tr>
                        <td><table width="100%" height="10" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                <td align="center"><font size="2" color="#000000">รายการข้อมูลทีเด็ด <?=$r[1];?> ทั้งหมด
                                  <?=$Num_Rows;?>
                                  รายการ : แสดงผลหน้าละ
                                  <?=$Per_Page;?>
                                  รายการ จำนวนทั้งหมด
