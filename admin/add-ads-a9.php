        ...
        <td bgcolor="#CCCCCC"><table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="760" align="center" valign="top" bgcolor="#FFFFFF"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="25"><strong><font size="2"><img src="../img/icon_bullet_arrow_small.gif" width="9" height="9" /></font><font color="#000000" size="2"> <a href="ads-a9.php">จัดการข้อมูลพื้นที่โฆษณาตำแหน่ง A9 ขนาด 250 px</a></font><font size="2">  <img src="images/arrow.gif" width="7" height="11" /> เพิ่มข้อมูล </font><font color="#000000" size="2">พื้นที่โฆษณาตำแหน่ง A9</font></strong></td>
                  </tr>
                  <tr>
                      ...
                      <table width="660" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td width="500"><select name="type" id="type" onchange="window.open(this.options[this.selectedIndex].value,'_self')">
                              ...
                              <option value="add-ads-a9.php?type=1" <?php if($type==1){ echo "selected"; } ?>>HTML CODE</option>
                              <option value="add-ads-a9.php?type=2" <?php if($type==2){ echo "selected"; } ?>>ผู้ลงโฆษณาทั่วไป</option>
                            </select>
                          </td>
                        </tr>
                      </table>
