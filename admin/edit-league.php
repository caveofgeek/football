...
$id=$_GET[id];
$s="SELECT * FROM `league` where id='$id'";
        ...
        <td bgcolor="#CCCCCC"><table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="760" align="center" valign="top" bgcolor="#FFFFFF"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="25"><strong><font size="2"><img src="../img/icon_bullet_arrow_small.gif" width="9" height="9" /> <a href="add-league.php">จัดการข้อมูลลีก</a> <img src="images/arrow.gif" width="7" height="11" /> แก้ไขข้อมูลลีก</font></strong></td>
                  </tr>
                  <tr>
                                  ...
                                  <table width="550" border="0" align="center" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                      ...
                                      <td width="390" align="left">
                                        <img src="../league-icon/<?=$r[2];?>" width="30" height="30" />
                                        <input name="file1" type="file" id="file1" style="width:180px;" />
                                        <input type="hidden" name="op" id="op" value="<?=$r[2];?>" />
...
return true ;
                      ...
                      <tr>
                        <td><table width="450" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#E9E9E6">
                            <tr>
                              <td width="40" height="30" align="center" valign="middle" bgcolor="#EFEFED"><strong><font color="#333333" size="2">icon</font></strong></td>
...
?>
                            <tr>
                              <td width="40" height="25" align="center" valign="middle"><img src="../league-icon/<?=$objResult[2];?>" width="30" height="30" /></td>
                              <td width="310" height="25" align="center" valign="middle"><font size="2">
                                <?=$objResult[1];?>
                              </font></td>
                              <td width="100" height="25" align="center" valign="middle"><font size="2"><a href="edit-league.php?id=<?=$objResult[0];?>"><img src="images/edit.gif" width="40" height="15" border="0" /> </a><a href="del-league.php?id=<?=$objResult[0];?>&op=<?=$objResult[2];?>" onclick="javascript:if(!confirm('ท่านต้องการลบข้อมูลจริงหรือไม่')){return false;}"> <img src="images/del.gif" width="40" height="15" border="0" /></a></font></td>
                            </tr>
                            <? } ?>
                        </table></td>
                      </tr>
