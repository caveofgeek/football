        ...
        <td bgcolor="#CCCCCC"><table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="760" align="center" valign="top" bgcolor="#FFFFFF"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="25"><strong><font size="2"><img src="../img/icon_bullet_arrow_small.gif" width="9" height="9" /> จัดการข้อมูลรายการแข่งขัน</font></strong></td>
                  </tr>
                  <tr>
                    <td><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="30"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                              <td width="300" align="left"><font size="2" color="#333333"><strong>:: ข้อมูลรายการแข่งขัน :: </strong></font></td>
                              <td width="450" align="right"><font size="2" color="#333333"><strong>[ <a href="add-game-match.php">เพิ่มข้อมูลรายการแข่งขัน</a>]
</strong></font></td>
                            </tr>
                          </table></td>
                      </tr>
                      <tr>
                        <td height="3"><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                          ...
                          <tr>
                            <td align="center"><font size="2" color="#FF0000">** ให้ทำการปิดการทายผลก่อนทำการแก้ไขข้อมูลผู้ชนะและใส่สกอร์ และเมื่อให้คะแนนการทายผลเกมส์แล้วจะไม่สามารถแก้ไข และ/หรือ ลบ และ/หรือ เปลี่ยนแปลงข้อมูลได้**</font></td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
                        <td><table width="720" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#E9E9E6">
                          <tr>
                            <td width="75" height="30" align="center" bgcolor="#EFEFED"><span class="style4">เวลา</span></td>
                            <td width="150" height="30" align="center" bgcolor="#EFEFED"><span class="style4">วันที่</span></td>
                            <td width="150" height="30" align="center" bgcolor="#EFEFED"><span class="style4">เจ้าบ้าน</span></td>
                            <td width="75" height="30" align="center" bgcolor="#EFEFED"><span class="style4">ผล</span></td>
...
<?php
		...
		$strSQL .=" ORDER BY game_date DESC LIMIT $Page_Start , $Per_Page";
		$objQuery  = mysql_query($strSQL);
		while($objResult = mysql_fetch_row($objQuery)){
?>
                          <tr>
                            <td width="75" height="20" align="center"><font size="2"><?php echo $objResult[10]; ?></font></td>
                            <td width="150" height="20" align="center"><font size="2">
                              <?php $game_date=DateThai($objResult[9]); echo $game_date; ?>
                            </font></td>
                            <td width="150" height="20" align="center"><font size="2">
                              <?php echo $objResult[2]; ?>
                            </font></td>
                            <td width="75" height="20" align="center"><font size="2">
