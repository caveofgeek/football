                              ...
                              <td><form method="post" action="p-edit-ban-word.php" enctype="multipart/form-data" name ="checkForm" id="checkForm" onsubmit="return check1()">
                                  <table width="460" border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                      ...
                                      <td width="10">&nbsp;</td>
                                      <td width="300" align="left"><input name="brand" type="text" id="brand" value="<?php echo $r[1]; ?>" />
