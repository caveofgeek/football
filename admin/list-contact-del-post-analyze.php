                      ...
                      <tr>
                        <td width="500" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <table width="480" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                <td align="left"><font size="2"><a href="../post-<?php echo $objResult[1]; ?>/<?php echo $url; ?>.html" style="color:#000000" target="_blank">
                            ...
                            <table width="120" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                <td align="center"><font size="2" color="#000000">
                                  <?php $postDate=$objResult[0]; echo DateTime($postDate); ?>
                                </font></td>
                              </tr>
                          </table></td>
