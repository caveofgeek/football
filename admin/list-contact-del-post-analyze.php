        ...
        <td bgcolor="#CCCCCC"><table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="760" align="center" valign="top" bgcolor="#FFFFFF"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="25"><strong><font size="2"><img src="../img/icon_bullet_arrow_small.gif" width="9" height="9" /> จัดการข้อมูลรายการแจ้งลบบทวิเคราะห์บอล</font></strong>					</td>
                  </tr>
                  <tr>
...
<?
		$strSQL = "SELECT contact_del_analyze_post.date, analyze.id, analyze.title, analyze.view, contact_del_analyze_post.id ";
		$strSQL .= "FROM `contact_del_analyze_post` ";
		$strSQL .= "INNER JOIN `analyze` ON contact_del_analyze_post.post_id=analyze.id ";
		...
		$strSQL .=" order  by analyze.id ASC LIMIT $Page_Start , $Per_Page";
		$objQuery  = mysql_query($strSQL);
                      ...
                      <tr>
                        <td width="500" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <table width="480" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                <td align="left"><font size="2"><a href="../post-<?=$objResult[1];?>/<?=$url;?>.html" style="color:#000000" target="_blank">
                                  <?=$objResult[2];?>
                                </a></font></td>
                              </tr>
                              <tr>
                        ...
                        <td width="100" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <table width="100" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                <td align="center"><font size="2"><a href="del-contact-del-post-analyze.php?id=<?=$objResult[1];?>" onclick="javascript:if(!confirm('ท่านต้องการลบข้อมูลจริงหรือไม่')){return false;}"><img src="images/del.gif" width="40" height="15" border="0" /></a> <a href="cancel-contact-del-post-analyze.php?id=<?=$objResult[4];?>" onclick="javascript:if(!confirm('ท่านต้องการยกเลิกจริงหรือไม่')){return false;}"><img src="images/cancel.gif" width="40" height="15" border="0" /></a></font></td>
                              </tr>
                            </table></td>
                      </tr>
                      <? } ?>
