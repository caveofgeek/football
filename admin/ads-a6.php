              ...
              ?>
                  ...
                  <textarea name="textarea" rows="10" style="width:600px;" disabled="disabled"><?php echo $ads; ?></textarea>
                                ...
                                <tr>
                                  ...
                                  <a href="edit-ads-a6.php?id=<?php echo $objResult1[0]; ?>" class='btn btn-warning btn-xs white'>
                                      <i class="glyphicon glyphicon-pencil"></i> แก้ไข
                                    </a>
                                    <a href="del-ads6.php?id=<?php echo $objResult1[0]; ?>" onclick="javascript:if(!confirm('ท่านต้องการลบข้อมูลจริงหรือไม่')){return false;}" class='btn btn-danger btn-xs white'>
                            ...
                            <form class="form-horizontal" role="form">
                                ...
                                <div class="form-group">
                                  <div class="col-sm-6">
                                    ...
                                    <a href="del-ads6.php?id=<?php echo $objResult1[0]; ?>&amp;op=<?php echo $objResult1[9]; ?>" onclick="javascript:if(!confirm('ท่านต้องการลบข้อมูลจริงหรือไม่')){return false;}" class='btn btn-danger btn-xs white'>
                                      <i class="glyphicon glyphicon-remove"></i> ลบ
                                    </a>
                                  </div>
                                </div>
