        ...
        <td bgcolor="#CCCCCC"><table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="760" align="center" valign="top" bgcolor="#FFFFFF"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="25"><strong><font size="2"><img src="../img/icon_bullet_arrow_small.gif" width="9" height="9" /> จัดการข้อมูลโฆษณาตำแหน่ง A1 728 x 90 px</font></strong></td>
                  </tr>
                  <tr>
                    <td>
                      <form id="form1" name="form1" method="post" action="p-ads-a1.php" enctype="multipart/form-data" class="form-horizontal" role="form" >
                      <div class="form-group">
                        ...
                        <div class="col-sm-5">
                          <select class="form-control" name="type" id="type" onchange="window.open(this.options[this.selectedIndex].value,'_self')">
                            ...
                            <option value="ads-a1.php?type=1" <?php if($type==1){ echo "selected"; } ?>>HTML CODE</option>
                            <option value="ads-a1.php?type=2" <?php if($type==2){ echo "selected"; } ?>>ผู้ลงโฆษณาทั่วไป</option>
                          </select>
                        </div>
                      </div>
                      <?php if($type==1){ ?>
