        ...
        <td bgcolor="#CCCCCC"><table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="760" align="center" valign="top" bgcolor="#FFFFFF"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="25"><strong><font size="2"><img src="../img/icon_bullet_arrow_small.gif" width="9" height="9" /></font><font color="#000000" size="2"> จัดการข้อมูลพื้นที่โฆษณาตำแหน่ง A4 ขนาด 728 px :: [ <a href="add-ads-a4.php">เพิ่มตำแหน่งโฆษณา ADS A4</a> ] :: </font></strong></td>
                  </tr>
                  <tr>
                    <td align="center">
					<?php
                        ...
                        <tr>
                          <td align="center" valign="top"><?php if($objResult1[1]==1){?>
                              <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                  <td align="left"><strong><font size="2"><a href="edit-ads-a4.php?id=<?php echo $objResult1[0]; ?>"><img src="images/edit.gif" width="40" height="15" border="0" /></a> <a href="del-ads4.php?id=<?php echo $objResult1[0]; ?>" onclick="javascript:if(!confirm('ท่านต้องการลบข้อมูลจริงหรือไม่')){return false;}"> <img src="images/del.gif" width="40" height="15" border="0" /></a></font></strong></td>
                                </tr>
                              </table>
                            <?php }else if($objResult1[1]==2){ ?>
                              <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                  ...
                                  <td width="10">&nbsp;</td>
                                  <td align="left"><font size="2"><a href="edit-ads-a4.php?id=<?php echo $objResult1[0]; ?>"><img src="images/edit.gif" width="40" height="15" border="0" /></a> <a href="del-ads4.php?id=<?php echo $objResult1[0]; ?>&amp;op=<?php echo $objResult1[9]; ?>" onclick="javascript:if(!confirm('ท่านต้องการลบข้อมูลจริงหรือไม่')){return false;}"> <img src="images/del.gif" width="40" height="15" border="0" /></a></font></td>
                                </tr>
                              </table>
                            <?php } ?></td>
                        </tr>
