...
<title>ติดต่อลงโฆษณา | <?=$titler[1];?></title>
<META NAME="keywords" CONTENT="<?=$titler[12];?>">
<META NAME="description" CONTENT="<?=$titler[1];?> ติดต่อลงโฆษณา <?=$titler[11];?>">
...
<? } ?>
            ...
            <tr>
              <td align="center"><table width="728" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="left" style="font-family:'Times New Roman', Times, serif; font-size:16px; font-weight:bold; color:#020202; border-bottom:2px solid #333333;">ติดต่อลงโฆษณา</td>
                </tr>
                <tr>
