...
<title>แจ้งลบบทวิเคราะห์บอล <?php echo $rpost[0]; ?> | <?php echo $titler[1]; ?></title>
          ...
          <td width="728" align="center" valign="top"><table width="728" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td align="center"><table width="728" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="left" style="font-family:'Times New Roman', Times, serif; font-size:16px; font-weight:bold; color:#020202; border-bottom:2px solid #333333;">แจ้งลบบทวิเคราะห์บอล : <?php echo $rpost[0]; ?></td>
                </tr>
                <tr>
