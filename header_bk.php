                  ...
                  <td align="center"><table width="728" border="0" align="center" cellpadding="0" cellspacing="0" style="background-image:url(http://<?php echo $titler[13]; ?>/img/bg-menu-top.png); background-repeat:no-repeat; height:42px;">
                      <tr>
                        <td align="center" valign="top"><table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                              <td height="23" align="center" valign="bottom" style="font-family:'Times New Roman', Times, serif; font-size:14px; font-weight:bold; color:#FFFFFF;"><a href="http://<?php echo $titler[13]; ?>" title="หน้าแรก" style="color:#FFFFFF;">หน้าแรก</a> | <a href="http://<?php echo $titler[13]; ?>/tded-ทีเด็ดบอลวันนี้" title="ทีเด็ดบอล" style="color:#FFFFFF;">ทีเด็ดบอล</a> | <a href="http://<?php echo $titler[13]; ?>/analyze-วิเคราะห์บอลวันี้" title="วิเคราะห์บอล" style="color:#FFFFFF;">วิเคราะห์บอล</a> | <a href="http://<?php echo $titler[13]; ?>/ball-1/โปรแกรมบอลวันนี้" title="โปรแกรมบอล" style="color:#FFFFFF;">โปรแกรมบอล</a> | <a href="http://<?php echo $titler[13]; ?>/ball-2/ผลบอลสด" title="ผลบอลสด" style="color:#FFFFFF;">ผลบอลสด</a> | <a href="http://<?php echo $titler[13]; ?>/ball-3/ดูบอลออนไลน์" title="ดูบอลออนไลน์" style="color:#FFFFFF;">ดูบอลออนไลน์</a> | <a href="http://<?php echo $titler[13]; ?>/contact.php" title="ติดต่อโฆษณา" style="color:#FFFFFF;">ติดต่อโฆษณา</a></td>
                            </tr>
                        </table></td>
                      </tr>
                  </table></td>
          ...
          <tr>
            <td height="45" align="center" style="background-image:url(http://<?php echo $titler[13]; ?>/img/bg-tab-login.png); border-top-right-radius:5px; border-top-left-radius:5px; -moz-border-radius-topright:5px; -moz-border-radius-topleft:5px; -webkit-border-top-right-radius:5px; -webkit-border-top-left-radius:5px;"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <table width="970" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="150" align="left"><a href="http://<?php echo $titler[13]; ?>" title="<?php echo $titler[1]; ?>" style="font-family:'Times New Roman', Times, serif; font-size:14; font-weight:bold; color:#FFFFFF;">
                      <?php echo $titler[1]; ?>
                    </a></td>
                    <td width="820" align="center"><?php if(isset($_SESSION["member_login"])){ ?>
                        <table width="820" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td align="right" style="font-family:'Times New Roman', Times, serif; color:#FFFFFF; font-size:12px;"><strong>ยินดีต้อนรับ
                              ...
                              :</strong> <a href="http://<?php echo $titler[13]; ?>/member/index.php" title="ข้อมูลส่วนตัว" style="color:#FFFFFF;">ข้อมูลส่วนตัว</a> | <a href="http://<?php echo $titler[13]; ?>/member/list-webboard.php" title="ข้อมูลกระทู้" style="color:#FFFFFF;">ข้อมูลกระทู้</a> | <a href="http://<?php echo $titler[13]; ?>/game/list-play-game.php" title="ประวัติการทายผล" style="color:#FFFFFF;">ประวัติการทายผล</a> | <a href="http://<?php echo $titler[13]; ?>/member/logout.php" title="ออกจากระบบ" style="color:#FFFFFF;">ออกจากระบบ</a></td>
                          </tr>
                        </table>
                      <?php }else{ ?>
                        <table width="820" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            ...
                            <td width="700" align="left"><form id="form1" name="form1" method="post" action="http://<?php echo $titler[13]; ?>/login.php">
                                  ...
                                  <tr>
                                    ...
                                    <td width="270" align="center"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        ...
                                        <table width="270" border="0" align="center" cellpadding="0" cellspacing="0">
                                          <tr>
                                            <td align="left"><input type="image" name="Submit" id="Submit" value="Submit" src="http://<?php echo $titler[13]; ?>/img/bt-login.png" />
                                              <a href="http://<?php echo $titler[13]; ?>/forgot-pass.php" title="ลืมรหัสผ่าน"><img src="http://<?php echo $titler[13]; ?>/img/bt-forgot-pass.png" alt="ลืมรหัสผ่าน" width="70" height="24" border="0" title="ลืมรหัสผ่าน" /></a> <a href="http://<?php echo $titler[13]; ?>/member-condition.php" title="สมัครสมาชิกใหม่"><img src="http://<?php echo $titler[13]; ?>/img/bt-register.png" alt="สมัครสมาชิกใหม่" width="107" height="24" border="0" title="สมัครสมาชิกใหม่" /></a></td>
                                          </tr>
                                      </table></td>
                                  </tr>
                                </table>
