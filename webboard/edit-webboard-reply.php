...
<title>แก้ไขข้อมูล ตอบคำถาม <?php echo $rart[0]; ?> | <?php echo $titler[1]; ?></title>
<META NAME="keywords" CONTENT="<?php echo $titler[12]; ?>"> 
<META NAME="description" CONTENT="<?php echo $titler[1]; ?> แก้ไขข้อมูล ตอบคำถาม <?php echo $rart[0]; ?> <?php echo $titler[11]; ?>">
                        ...
                        <tr>
                          <td align="left"><strong><font size="2">รายละเอียด
                            <input type="hidden" id="id" name="id" value="<?php echo $id; ?>" />
                                  ...
                                  <input type="hidden" id="topic" name="topic" value="<?php echo $url; ?>" />
                          </font></strong></td>
                        </tr>
                        <tr>
                          <td align="left"><textarea class="cleditorMain" id="input" name="input" style="width:950px; height:450px;"><?php echo $rre[0]; ?>
        </textarea></td>
                        </tr>
                        <tr>
                          <td align="left"><strong><font size="2">ไฟล์ภาพ
                            <input name="file1" type="file" id="file1" />
                                  <?php if($rre[1]!=""){?>
                                  <a href="http://<?php echo $titler[13]; ?>/webboard/board-img/<?php echo $rre[1]; ?>" title="" target="_blank">คลิกที่นี่เพื่อดูภาพประกอบ</a>
                                  <input type="hidden" name="op" id="op" value="<?php echo $rre[1]; ?>" />
                                  <?php } ?>
