...
<title>ตอบคำถาม <?php echo $rart[0]; ?> | <?php echo $titler[1]; ?></title>
<META NAME="keywords" CONTENT="<?php echo $titler[12]; ?>"> 
<META NAME="description" CONTENT="<?php echo $titler[1]; ?> ตอบคำถาม <?php echo $rart[0]; ?> <?php echo $titler[11]; ?>">
        ...
        <tr>
          <td height="32" style="background-image:url(http://<?php echo $titler[13]; ?>/img/bg-tab-login.png); background-repeat:repeat-x;"><table width="970" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td width="935" align="left" style="font-size:14px; color:#FFFFFF; font-weight:bold;"> RE :
                  <?php echo $rart[0]; ?></td>
              </tr>
          </table></td>
        </tr>
